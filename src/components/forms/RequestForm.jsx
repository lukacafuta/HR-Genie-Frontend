...
export default function RequestForm({ isModalOpen, closeModal }) {
    ...
    return (
        <>
            <ModalOverlay>
                <Modal>
                    <div style={{display: 'flex', marginBottom: '6px', justifyContent: 'space-between', alignItems: 'center'}}>
                        <h2>Request Form</h2>
                        <BtnClose src="close-cross.png" alt="Close Button" onClick={closeModal} width='18px' height='18px'/>
                    </div>
                    <ZeForm
                        action="submit"
                    ...
                    >
                        <div>
                            <FormLabel htmlFor="inputRequestType">
                                Request Type
                            </FormLabel>
                            <FormInputSelect
                                id="inputRequestType"
                        ...
                        {(requestType === 'Vacation' || requestType === 'Absence') && (
                            <div>
                                <div style={{display: 'flex', gap: '6px'}}>
                                    <div>
                                        <FormLabel htmlFor="inputFromDate">
                                            From
                                        </FormLabel>
                                        <FormInputBasic
                                            id="inputFromDate"
                        ...
                        {(requestType === 'Training') && (
                            <div>
                                <div style={{display: 'flex', gap: '6px'}}>
                                    <div>
                                        <FormLabel htmlFor="inputFromDateTraining">
                                            From
                                        </FormLabel>
                                        <FormInputBasic
                                    ...
                                    <div>
                                        <FormLabel htmlFor="inputToDateTraining">
                                            To
                                        </FormLabel>
                                        <FormInputBasic
                                ...
                                <div>
                                    ...
                                    <FormLabel htmlFor="inputTrainingURL">
                                        Training URL
                                    </FormLabel>
                                    <FormInputBasic
                                        id="inputTrainingURL"
                        ...
                        {requestType !== '' && (
                            <div>
                                <div>
                                    <FormLabel htmlFor="inputComment">
                                        Comment
                                    </FormLabel>
                                    <FormInputTextArea
                                        id="inputComment"
                                ...
                                <div style={{display: 'flex', justifyContent: 'flex-end', marginTop: '10px'}}>
                                    <ButtonBrand iconURL={'tick-circle.png'} buttonText='Send Request'  type="submit"/>
                                </div>
                            </div>)}
